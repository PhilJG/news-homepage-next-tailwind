...
export default function Header() {
    return (
        <header className='lg:grid  lg:grid-cols-3 lg:gap-x-8 lg:gap-y-10s'>
            <Image src={Mobile} className="col-span-2 lg:col-start-1 lg:col-span-2 " alt='Web3 abstract image' />
            <h1 className='lg:text-5xl text-4xl font-[800] leading-10 lg:text-base-loose pt-6 inline-block max-h-fit-content lg:col-span-1 lg:row-start-2 text-6xl'>The Bright Future of Web 3.0?</h1>
            <div className='lg:row-start-2 lg:col-start-2 mb-16 lg:mb-0 pt-6'>
